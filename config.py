...
def get_config(case):
    if case == 'train_decoding': 
        ...
        parser.add_argument('--two_step', dest='two_step', action='store_true', help='Run the two-step training processn when true')
        parser.add_argument('--one_step', dest='two_step', action='store_false', help='Run only the first step training process when false')
