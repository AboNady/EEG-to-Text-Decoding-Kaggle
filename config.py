...
def get_config(case):
    if case == 'train_decoding': 
        ...
        parser.add_argument('--two_step', dest='skip_step_one', action='store_true', help='Run the two-step training processn when true')
        parser.add_argument('--one_step', dest='skip_step_one', action='store_false', help='Run only the first step training process when false')
...
#        parser.add_argument('-2step', '--two_step', dest='skip_step_one', action='store_false')
        ...
        parser.add_argument('-load1', '--load_step1_checkpoint', dest='load_step1_checkpoint', action='store_false')
